        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center gap-2">
            ...
            {user?.role?.toLowerCase() === 'admin' && (
              <Link
                href="/admin/posts"
                className="hidden sm:inline-flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium bg-primary/10 text-primary hover:bg-primary/20 transition-all"
              >
