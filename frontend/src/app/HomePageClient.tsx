          ...
          <a
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-lg border transition-all group ${
              isTech
                ...
                : 'border-gray-200 text-gray-600 hover:border-violet-500/50 hover:text-violet-600 dark:border-gray-700 dark:text-gray-400'
            }`}
          >
            ...
            <span className={`text-sm ${isTech ? 'font-["Space_Grotesk"]' : ''}`}>GitHub</span>
          </a>
        </div>
      </div>
    </nav>
