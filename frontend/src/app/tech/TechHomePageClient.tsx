...
interface TechHomePageClientProps {
  posts: Post[];
  series: Series[];
  tags: Tag[];
}
  ...
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl">
        ...
        {/* 描述 */}
        <p className="font-['Space_Grotesk'] text-lg text-gray-400 max-w-2xl mx-auto mb-12 leading-relaxed">
    ...
    >
      <div className="relative p-6 rounded-2xl bg-[#0a0a0f]/50 border border-gray-800/50 backdrop-blur-sm overflow-hidden transition-all duration-500 hover:border-cyan-500/30 hover:shadow-2xl hover:shadow-cyan-500/10">
        ...
        <div className="relative z-10">
          ...
          {/* 摘要 */}
          <p className="font-['Space_Grotesk'] text-gray-400 text-sm mb-4 line-clamp-2 leading-relaxed">
            {post.excerpt || '暂无简介'}
          </p>
        ...
        {/* 边框光效 */}
        <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-cyan-500/0 via-cyan-500/0 to-cyan-500/0 group-hover:from-cyan-500/10 group-hover:via-transparent group-hover:to-cyan-500/10 transition-all duration-500 pointer-events-none" />
      </div>
    </Link>
  );
}
    ...
    <section className="relative py-24 px-6">
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="font-['Space_Grotesk'] text-gray-400">Latest Posts</p>

          {/* 查看全部按钮 */}
          <div className="mt-4">
            <Link
              href="/posts"
              className="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-gray-700 text-gray-300 hover:text-white hover:border-cyan-500/50 transition-all font-['Space_Grotesk'] text-sm"
            >
              查看全部
    ...
    >
      <div className="relative h-full p-6 rounded-2xl bg-[#0a0a0f]/50 border border-gray-800/50 backdrop-blur-sm overflow-hidden transition-all duration-500 hover:border-cyan-500/30">
        ...
        <div className="relative z-10">
          ...
          {/* 描述 */}
          <p className="font-['Space_Grotesk'] text-gray-400 text-sm line-clamp-2 leading-relaxed">
    ...
    <section className="relative py-24 px-6">
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="font-['Space_Grotesk'] text-gray-400">Series Collection</p>
        </div>
    ...
    <section className="relative py-24 px-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="font-['Space_Grotesk'] text-gray-400">Explore by Topic</p>
        </div>
...
// ==================== 主客户端组件 ====================
export function TechHomePageClient({ posts, series, tags }: TechHomePageClientProps) {
  return (
